void B3a(){
	...
	TString filename = "~/opt/basic1/B3/B3a/scoring.root";
	TFile*f = TFile::Open(filename);
	
	TH1F*h1 = new TH1F("crystal_edep_eventId","",400,0,100);
	TH1F*h2 = new TH1F("crystal_edep_cell","",400,0,35);
	TH1F*h3 = new TH1F("crystal_edep_score","",400,0,0.6);

	TH1F*h4 = new TH1F("eventId","",400,0,100);
	TH1F*h5 = new TH1F("cell","",400,0,200);
	TH1F*h6 = new TH1F("score","",400,0,0.00000001);
